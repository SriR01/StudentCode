  ...
  <div class="container">
    <table id="tblUsers">
      ...
      <tbody>
        <tr>
          <td>
            <input type="checkbox" id="selectAll" v-model='selectAll' v-on:change = "toggleAllUsers" />
          </td>
          <td>
        ...
        >
          ...
          <td>
            ...
            v-on:click="flipStatus(user.id)">{{user.status === 'Active' ? 'Disable' : 'Enable'}}
            </button>
          </td>
        </tr>
      </tbody>
